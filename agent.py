...
<div class="stitle">全指标品类下探 <span class="stitle-note">（权重 = 品类当前周订单量 ÷ 大盘当前周总订单量）</span></div>
